...
export class ChallengesController {
    ...
    async createChallenges(req: Request, res: Response) {
        try {
            ...
            const result = await this.challengesServices.createChallenges(id_company, validChallenges);
    ...
    async updateNonTechnicalDetails(req: Request, res: Response) {
        try {
            ...
            const result =
                await this.challengesServices.updateNonTechnicalDetails(
                    challengeId,
                    id_company,
                    data
                );
    ...
    async updateNonTechnicalQuestion(req: Request, res: Response) {
        try {
            ...
            const result =
                await this.challengesServices.updateNonTechnicalQuestion(
                    questionId,
                    id_company,
                    data
                );
    ...
    async updateNonTechnicalOption(req: Request, res: Response) {
        try {
            ...
            const result =
                await this.challengesServices.updateNonTechnicalOption(
                    optionId,
                    id_company,
                    data
                );
    ...
    async createNonTechnicalOption(req: Request, res: Response) {
        try {
            ...
            const result =
                await this.challengesServices.createNonTechnicalOption(
                    questionId,
                    id_company,
                    data
                );
